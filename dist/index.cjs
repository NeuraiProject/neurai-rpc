...
$parcel$export(module.exports, "getDePinRPC", () => $9df46f7047db01a3$export$e3c4528d9eee3c6);
$parcel$export(module.exports, "requestDePinChallenge", () => $9df46f7047db01a3$export$9d7d174baf084291);
 ...
 */ async function $9df46f7047db01a3$var$requestChallenge(url, authOptions) {
 ...
 */ async function $9df46f7047db01a3$var$postDePinData(url, data, challenge, signature) {
    const response = await fetch(url, {
        method: 'POST',
        mode: 'cors',
        headers: {
 ...
 */ async function $9df46f7047db01a3$var$ensureValidChallenge(context, requiredMode) {
    const now = Date.now();
    ...
    const challengeData = await $9df46f7047db01a3$var$requestChallenge(context.url, authOptions);
...
function $9df46f7047db01a3$export$e3c4528d9eee3c6(url, authOptions) {
    ...
    return async function depinRpc(method, params) {
        return new Promise(async (resolve, reject)=>{
            try {
                ...
                // Get valid challenge
                const challenge = await $9df46f7047db01a3$var$ensureValidChallenge(context, requiredMode);
                ...
                // Make request
                const response = await $9df46f7047db01a3$var$postDePinData(url, requestData, challenge, signature);
                if (response.ok) {
...
async function $9df46f7047db01a3$export$9d7d174baf084291(url, authOptions) {
    return $9df46f7047db01a3$var$requestChallenge(url, authOptions);
}
