...
&nbsp;<br> &nbsp;<br/>
## depinclearmsg
&nbsp;<br/>  depinclearmsg ( "all" | hours ) ( "scope" )
...
&nbsp;<br> &nbsp;<br/>
## depinreceivemsg
&nbsp;<br/>  depinreceivemsg "token" "address" (timestamp) ("after_hash") (limit)
...
&nbsp;<br> &nbsp;<br/>
## depinsubmitmsg
&nbsp;<br/>  depinsubmitmsg "hexmessage"|{"sender":"...","encrypted":"..."}
